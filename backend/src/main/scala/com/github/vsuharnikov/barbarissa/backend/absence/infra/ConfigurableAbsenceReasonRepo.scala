package com.github.vsuharnikov.barbarissa.backend.absence.infra

import com.github.vsuharnikov.barbarissa.backend.absence.domain.{AbsenceReason, AbsenceReasonRepo}
